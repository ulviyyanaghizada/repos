    ...
    public partial class CreateAll : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MostAnswers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MostFrequents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrFacilities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    PFeatureId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrekkingDifficulties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrekkingDifficulties_Difficulties_DifficultyId",
                        column: x => x.DifficultyId,
                        principalTable: "Difficulties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrekkingDifficulties_Trekkings_TrekkingId",
                        column: x => x.TrekkingId,
                        principalTable: "Trekkings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TrekkingId = table.Column<int>(type: "int", nullable: false),
                    TrFacilitieId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrekkingFacilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrekkingFacilities_TrFacilities_TrFacilitieId",
                        column: x => x.TrFacilitieId,
                        principalTable: "TrFacilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TrekkingId = table.Column<int>(type: "int", nullable: false),
                    TrFeatureId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrekkingFeatures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrekkingFeatures_TrFeatures_TrFeatureId",
                        column: x => x.TrFeatureId,
                        principalTable: "TrFeatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TourId = table.Column<int>(type: "int", nullable: false),
                    TFeatureId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrekkingDifficulties_DifficultyId",
                table: "TrekkingDifficulties",
                column: "DifficultyId");

            migrationBuilder.CreateIndex(
                name: "IX_TrekkingDifficulties_TrekkingId",
                table: "TrekkingDifficulties",
                column: "TrekkingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrekkingFacilities_TrFacilitieId",
                table: "TrekkingFacilities",
                column: "TrFacilitieId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrekkingFeatures_TrFeatureId",
                table: "TrekkingFeatures",
                column: "TrFeatureId");
